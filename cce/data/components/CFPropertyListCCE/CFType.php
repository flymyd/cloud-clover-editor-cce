...
abstract class CFType {
   ...
   */
  public function __construct($value=null, $hexAsInt=false) {
    $this->setValue($value);
...
class CFData extends CFType {
   ...
   */
  public function __construct($value=null,$already_coded=true) {
  ...
  /**
   * Get the hex CFType's value.
   * @return mixed CFType's value
   */
  public function getValue() {
    $base64 = base64_decode($this->value);

    return bin2hex($base64);
  }
